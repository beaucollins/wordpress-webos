...
enyo.kind({
  ...
  setResponse: function(inXHR){
	  ...
	  if (inXHR.status == 200) {
		  ...
		  console.log(responseTest); //log the original response
		  //remove the BOM bytes, white spaces
		  if (responseTest.indexOf("<")!=0){
			  console.log("cleaning the response message");
			  responseTest =  responseTest.substring(responseTest.indexOf("<"));
		  ...
		  //TODO: escape the double encoded entity.
